...
public enum PUBGSeason {
    ...
    PRE6_2017("2017-pre6", "Early Access Season #6"),
    RELEASE_2018_01("2018-01", "2018 Season #1"),
    RELEASE_2018_02("2018-02", "2018 Season #2"),
    RELEASE_2018_03("2018-03", "2018 Season #3");
